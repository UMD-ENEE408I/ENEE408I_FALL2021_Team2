...
void loop()
{
  ...
  float adjusted_encoder_value = current_encoder_value - right_beginning_encoder_value;  //again for testing the leat wheel
  ...
  int rightPWM = -motor_control_sig;    //commenting out until testing the right motor
