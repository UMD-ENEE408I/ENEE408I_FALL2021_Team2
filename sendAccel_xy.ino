...
//BLEFloatCharacteristic Accel3Char("2e0b7a48-510d-4779-abc9-d4b52067341e", BLERead | BLEWrite);
...
void setup() {
  ...
  /*BLE.setAdvertisedService(accelerationService);
  accelerationService.addCharacteristic(Accel3Char);
  BLE.addService(accelerationService);*/
  ...
  /*Accel3Char.setEventHandler(BLEWritten, Accel3CharWritten);
  accelerationCharacteristic.setValue(0);*/
...
/*void Accel3CharWritten(BLEDevice central, BLECharacteristic characteristic) {
  Serial.print("Acceleration3CharacteristicWritten: ");
  unsigned int k = Accel3Char.value();
  short v = (short)((k>>0) & 0x0000FFFF);
  Serial.print(v);
  Serial.print(" ");
}*/
