...
void PID_Motor_Control(float left)   //just testing the left in this code for now
{
...
void loop()
{
  ...
  float left_error_sig = left_position_cm - position_setpoint;
